...
export default function App() {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll('.section-heading, .section-content')
  ...
  useEffect(() => {
    fetch(
      'https://api.github.com/repos/sampratigaurav/syncwatch/commits?per_page=1'
    )
      .then((r) => r.json())
      .then((data) => {
        if (data[0]) {
  ...
  return (
    ...
    >
      ...
      {isMobile ? (
        ...
        >
          {['Intro', 'Work', 'Writing', 'Certs', 'About', 'Contact'].map(
            (section) => (
              <button
                key={section}
                onClick={() =>
                ...
                style={{
                  ...
                  padding: '8px 4px',
                  fontWeight:
                    activeSection === section.toLowerCase() ? 500 : 300,
                }}
              >
                {section}
              </button>
                        ...
                        <div
                          ...
                          style={{
                            ...
                            background: day
                              ...
                              : 'transparent',
                            border: day
                              ? `1px solid ${borders[day.level] ?? borders[0]}`
                              : 'none',
        ...
        <section id="about" className="section">
          ...
          <div className="section-content">
            ...
            >
              ...
              >
                I'm a Cybersecurity undergrad at Dayananda Sagar University,
                Bengaluru. I got into tech because I was curious about how
                systems break — and I stayed because I realized I could build
                things that don't.
              </p>
              <p
                style={{
              ...
              >
                I write on Hashnode because the clearest test of understanding
                is whether you can explain it simply. 15 technical articles and
                counting — on networking, git internals, web fundamentals, and
              ...
              >
                I competed in a 24-hour Techflix Hackathon at DSU. I learn in
                public on X, ship on GitHub, and I think the most dangerous
                combination in tech is curiosity paired with consistency.
              </p>
              <p
                style={{
                  color: isDark ? 'rgba(255,255,255,0.85)' : 'rgba(0,0,0,0.75)',
              ...
              >
                Building something from nothing and watching it actually work —
                that's what keeps me going. Most students wait to be ready. I
                don't.
              </p>
            </div>
          </div>
        ...
        <section id="contact" className="section contact-section">
          ...
          >
            <span
              ...
              onMouseEnter={(e) => (e.target.style.color = '#4A9EFF')}
              onMouseLeave={(e) =>
                (e.target.style.color = isDark ? '#fff' : '#111')
              }
            >
      ...
      >
        ...
        <div style={{ color: isDark ? '#fff' : '#111', fontSize: '13px' }}>
          2nd year @ DSU
        </div>
